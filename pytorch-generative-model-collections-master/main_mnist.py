...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='noise-mnist', choices=['noise-cifa10','noise-mnist','mnist', 'fashion-mnist', 'cifar10', 'cifar100', 'svhn', 'stl10', 'lsun-bed'],
                        help='The name of dataset')
    parser.add_argument('--split', type=str, default='', help='The split flag for svhn and stl10')
    parser.add_argument('--epoch', type=int, default=9999, help='The number of epochs to run')
